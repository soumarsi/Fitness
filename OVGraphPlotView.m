...
- (void)drawRect:(CGRect)rect{
    ...
    if (self.delegate.graphcolor==nil) {
        opaquecolor=[UIColor colorWithRed:(45.0f/255.0f) green:(179.0f/255.0f) blue:(17450.0f/255.0f) alpha:1];
    }
    //calculate colors
	...
	lightercolor = [UIColor clearColor];
	...
	lightestcolor= [[UIColor colorWithRed:(45.0f/255.0f) green:(179.0f/255.0f) blue:(1565470.0f/255.0f) alpha:1]colorWithAlphaComponent:.2];
        ...
        for (OVGraphViewPoint *point in _plotpoints) {
          ...
          //  NSLog(@"x:%d",xpoint);
           ...
           // NSLog(@"%d%d",spacebetweenpoints,yscale);
            ...
            [point.xlabel drawAtPoint:CGPointMake(xpoint-15, self.frame.size.height-20) withFont:[UIFont fontWithName:@"Futura" size:12]];
            int yvalueoffset;
            yvalueoffset=0-30;
