...
- (IBAction)login:(id)sender
{
    ...
    [jsonOBJ GetJsonObjectFromURL:[NSString stringWithFormat:@"%@login/verify_app_login?email=%@&password=%@&remember_me=%@",App_Domain_Url,_email.text,_password.text,Remember_Status] WithSpinner:nil Withblock:^(id JsonResult, NSError *error)
