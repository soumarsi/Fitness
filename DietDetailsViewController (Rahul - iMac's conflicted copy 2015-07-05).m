...
- (void)viewDidLoad {
   ...
   //--//
    ...
    _diet_description.font=[UIFont fontWithName:@"TitilliumWeb-Regular" size:16.0f];
         ...
         if(_diet_description.text.length>380)
         {
             
             [_Diet_Scroll setContentSize:CGSizeMake([UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.width+350)];

         }
         else if (_diet_description.text.length>380*2)
         {
              [_Diet_Scroll setContentSize:CGSizeMake([UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.width+550)];
         }
         else if (_diet_description.text.length>1000)
         {
             [_Diet_Scroll setContentSize:CGSizeMake([UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.width+800)];
         }
